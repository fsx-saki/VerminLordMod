...
namespace VerminLordMod.Content.Items.Consumables
{
	class Hopeness : ModItem, IGu
	{
		...
		public override void ModifyItemLoot(ItemLoot itemLoot) {
			itemLoot.Add(ItemDropRule.OneFromOptions(1, ModContent.ItemType<ZizhiJia>(), ModContent.ItemType<ZizhiYi>(), ModContent.ItemType<ZizhiBing>(), ModContent.ItemType<ZizhiDing>()));
