...
{
	/// <summary>
	/// 四转道蛊虫 — GiantSpiritHeartGu
	/// 蛊虫

	/// </summary>
	class GiantSpiritHeartGu : EatingWeapon
	{
		...
		public override bool? UseItem(Player player) {
			...
			player.AddBuff(ModContent.BuffType<Content.Buffs.AddToSelf.Pobuff.GiantSpiritHeartbuff>(), 3600);
			return true;
		}
	}
}
