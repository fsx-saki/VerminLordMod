...
namespace VerminLordMod.Content.Items.Weapons.Four
{
    /// <summary>
    /// 四转力道蛊虫 — 横冲直撞蛊
    /// 由横冲蛊和直撞蛊合炼而成的四转蛊虫，用于快速冲锋移动。
    /// </summary>
    public class HengChongZhiZhuangGu : PowerWeapon, IOnHitEffectProvider
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<HengChongZhiZhuangProj>();
            Item.shootSpeed = 13f;
            Item.noMelee = true;
