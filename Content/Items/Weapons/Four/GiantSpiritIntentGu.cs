...
{
	/// <summary>
	/// 四转道蛊虫 — GiantSpiritIntentGu
	/// 蛊虫

	/// </summary>
	class GiantSpiritIntentGu : EatingWeapon
	{
		...
		public override bool? UseItem(Player player) {
			...
			player.AddBuff(ModContent.BuffType<Content.Buffs.AddToSelf.Pobuff.GiantSpiritIntentbuff>(), 3600);
			return true;
		}
	}
}
