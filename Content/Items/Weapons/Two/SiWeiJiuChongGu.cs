...
namespace VerminLordMod.Content.Items.Weapons.Two
{
    /// <summary>
    /// 二转气道蛊虫 — 四味酒虫
    /// 二转蛊虫，有精炼真元的能力，方源计划由酒虫合炼而成，需要两只酒虫和四种美酒（酸甜苦辣）。
    /// </summary>
    public class SiWeiJiuChongGu : QiWeapon, IOnHitEffectProvider
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<SiWeiJiuChongProj>();
            Item.shootSpeed = 11f;
            Item.noMelee = true;
