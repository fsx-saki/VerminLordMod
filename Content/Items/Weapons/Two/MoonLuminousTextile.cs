...
{
	/// <summary>
	/// 二转道蛊虫 — MoonLuminousTextile
	/// 蛊虫

	/// </summary>
	class MoonLuminousTextile : EatingWeapon
	{
		...
		public override bool? UseItem(Player player) {
			...
			player.AddBuff(ModContent.BuffType<Content.Buffs.AddToSelf.Pobuff.MoonLuminousTextilebuff>(), 360);
			return true;
		}
	}
}
