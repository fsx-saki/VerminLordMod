...
namespace VerminLordMod.Content.Items.Weapons.Two
{
    /// <summary>
    /// 二转力道蛊虫 — 白玉蛊
    /// 二转防御型蛊虫，由玉皮蛊和白豕蛊合炼而成，保留了玉皮蛊的防御能力并强化，但丧失了白豕蛊的力量增强效果。方源拥有。
    /// </summary>
    public class BaiYuGu : PowerWeapon, IOnHitEffectProvider
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<BaiYuProj>();
            Item.shootSpeed = 11f;
            Item.noMelee = true;
