...
{
	class LoveToLeave : PoisonWeapon//必要继承moditem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<LoveToLeaveProj>();
			Item.shootSpeed = 10f;
		}
		...
		public override void AddRecipes() {// 这个括号里有一个默认的参数1，你可以填任何大于0的整数。它代表了这个合成表会生成多少个物品
			...
			.AddIngredient(ModContent.GetInstance<LivingGrass>(), 1)
			.AddIngredient(ModContent.GetInstance<WidowSpider>(), 1)
			.AddIngredient(ModContent.GetInstance<RedNeedleScorpion>(), 1)
