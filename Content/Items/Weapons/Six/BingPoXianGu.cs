...
namespace VerminLordMod.Content.Items.Weapons.Six
{
    /// <summary>
    /// 六转冰雪道蛊虫 — 冰魄仙蛊
    /// 六转野生仙蛊，冰系，形似蜘蛛，通体乳白色，八爪，背部有蓝色花纹，描绘出冤魂哀嚎模样。
    /// </summary>
    public class BingPoXianGu : IceSnowWeapon, IOnHitEffectProvider
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<BingPoXianProj>();
            Item.shootSpeed = 15f;
            Item.noMelee = true;
