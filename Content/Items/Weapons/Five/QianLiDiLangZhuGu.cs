...
namespace VerminLordMod.Content.Items.Weapons.Five
{
    /// <summary>
    /// 五转血道蛊虫 — 千里地狼蛛
    /// 五转坐骑蛊，花酒行者所有，被血狂污染后自我封印，方源唤醒后发狂。
    /// </summary>
    public class QianLiDiLangZhuGu : BloodWeapon, IOnHitEffectProvider
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<QianLiDiLangZhuProj>();
            Item.shootSpeed = 14f;
            Item.noMelee = true;
