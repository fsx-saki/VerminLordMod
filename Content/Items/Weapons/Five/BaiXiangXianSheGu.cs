...
namespace VerminLordMod.Content.Items.Weapons.Five
{
    /// <summary>
    /// 五转冰雪道蛊虫 — 白相仙蛇蛊
    /// 五转仙蛇，白色，会飞行，能喷吐迷津雾，并非白凝冰炼化而是被其体质吸引。
    /// </summary>
    public class BaiXiangXianSheGu : IceSnowWeapon, IOnHitEffectProvider
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<BaiXiangXianSheProj>();
            Item.shootSpeed = 14f;
            Item.noMelee = true;
