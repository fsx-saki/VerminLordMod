...
namespace VerminLordMod.Content.Items.Weapons.Five
{
	class WarBoneWheel : BoneWeapon
	{
		...
		protected override int qiCost => 1000;
		...
		public override void SetStaticDefaults() {
			...
			ItemID.Sets.GamepadExtraRange[Item.type] = 34; // Increases the gamepad range. Some vanilla values: 4 (Wood), 10 (Valor), 13 (Yelets), 18 (The Eye of Cthulhu), 21 (Terrarian).
		...
		public override void SetDefaults() {
			...
			Item.damage = 750; // The amount of damage the item does to an enemy or player.
			...
			Item.value = Item.buyPrice(gold: 70); // The amount of money that the item is can be bought for.

			Item.shoot = ModContent.ProjectileType<WarBoneWheelProj>(); // Which projectile this item will shoot. We set this to our corresponding projectile.
