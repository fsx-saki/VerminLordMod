...
namespace VerminLordMod.Content.Items.Weapons.Three
{
    /// <summary>
    /// 三转月道蛊虫 — 七香酒虫
    /// 一转蛊虫，能精炼一转青铜真元，提升一个小境界。是方源拥有的重要蛊虫，计划合炼为四味酒虫。
    /// </summary>
    public class QiXiangJiuChongGu : MoonWeapon, IOnHitEffectProvider
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<QiXiangJiuChongProj>();
            Item.shootSpeed = 12f;
            Item.noMelee = true;
