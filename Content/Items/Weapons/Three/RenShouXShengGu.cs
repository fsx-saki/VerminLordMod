...
namespace VerminLordMod.Content.Items.Weapons.Three
{
    /// <summary>
    /// 三转火道蛊虫 — 人兽葬生蛊
    /// 三转消耗型蛊虫，通过让野兽吞食处女蛊师后合炼而成，可大幅提升修为但有后遗症。
    /// </summary>
    public class RenShouXShengGu : FireWeapon, IOnHitEffectProvider
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<RenShouXShengProj>();
            Item.shootSpeed = 12f;
            Item.noMelee = true;
