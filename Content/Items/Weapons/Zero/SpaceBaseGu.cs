...
namespace VerminLordMod.Content.Items.Weapons.Zero
{
    ...
    /// 体现空道"空间扭曲"的核心特点
    /// </summary>
    public class SpaceBaseGu : SpaceWeapon, IOnHitEffectProvider
    {
        ...
        public DaoEffectTags[] OnHitEffects => new[] { DaoEffectTags.Pull };
        ...
        public override void SetDefaults()
        {
            ...
            Item.crit = 4;
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<SpaceBaseProj>();
            Item.shootSpeed = 10f;
        }
    }
}
