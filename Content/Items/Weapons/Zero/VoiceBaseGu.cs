...
namespace VerminLordMod.Content.Items.Weapons.Zero
{
    ...
    /// 体现音道"音波震荡"的核心特点
    /// </summary>
    public class VoiceBaseGu : VoiceWeapon, IOnHitEffectProvider
    {
        ...
        public DaoEffectTags[] OnHitEffects => new[] { DaoEffectTags.Silence };
        ...
        public override void SetDefaults()
        {
            ...
            Item.crit = 4;
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<VoiceBaseProj>();
            Item.shootSpeed = 12f;
        }
    }
}
