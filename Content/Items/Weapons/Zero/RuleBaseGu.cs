...
namespace VerminLordMod.Content.Items.Weapons.Zero
{
    ...
    /// 体现律道"规则束缚"的核心特点
    /// </summary>
    public class RuleBaseGu : RuleWeapon, IOnHitEffectProvider
    {
        ...
        public DaoEffectTags[] OnHitEffects => new[] { DaoEffectTags.Disarm };
        ...
        public override void SetDefaults()
        {
            ...
            Item.crit = 4;
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<RuleBaseProj>();
            Item.shootSpeed = 10f;
        }
    }
}
