...
namespace VerminLordMod.Content.Items.Weapons.Zero
{
    ...
    /// 体现光道"光芒万丈"的核心特点
    /// </summary>
    public class LightBaseGu : LightWeapon, IOnHitEffectProvider
    {
        ...
        public DaoEffectTags[] OnHitEffects => new[] { DaoEffectTags.Blind };
        ...
        public override void SetDefaults()
        {
            ...
            Item.crit = 4;
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<LightBaseProj>();
            Item.shootSpeed = 14f;
        }
    }
}
