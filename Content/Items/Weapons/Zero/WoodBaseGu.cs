...
namespace VerminLordMod.Content.Items.Weapons.Zero
{
    /// <summary>
    /// 木道基础蛊 — 木藤蛊
    /// 发射一枚木道能量弹，命中后附加减速、牵引效果
    /// 体现木道"藤蔓缠绕"的核心特点
    /// </summary>
    public class WoodBaseGu : WoodWeapon, IOnHitEffectProvider
    {
        ...
        public DaoEffectTags[] OnHitEffects => new[] { DaoEffectTags.Slow, DaoEffectTags.Pull };
        ...
        public override void SetDefaults()
        {
            ...
            Item.crit = 4;
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<WoodBaseProj>();
            Item.shootSpeed = 10f;
        }
    }
}
