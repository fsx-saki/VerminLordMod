...
namespace VerminLordMod.Content.Items.Weapons.Zero
{
    /// <summary>
    /// 魂道基础蛊 — 魂火蛊
    /// 发射一枚魂道能量弹，命中后附加灼伤、恐惧效果
    /// 体现魂道"灵魂灼烧"的核心特点
    /// </summary>
    public class SoulBaseGu : SoulWeapon, IOnHitEffectProvider
    {
        ...
        public DaoEffectTags[] OnHitEffects => new[] { DaoEffectTags.DoT, DaoEffectTags.Fear };
        ...
        public override void SetDefaults()
        {
            ...
            Item.crit = 4;
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<SoulBaseProj>();
            Item.shootSpeed = 10f;
        }
    }
}
