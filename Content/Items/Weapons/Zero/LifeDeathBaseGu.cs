...
namespace VerminLordMod.Content.Items.Weapons.Zero
{
    /// <summary>
    /// 生道基础蛊 — 生死蛊
    /// 发射一枚生道能量弹，命中后附加灼伤、治疗效果
    /// 体现生道"生死轮转"的核心特点
    /// </summary>
    public class LifeDeathBaseGu : LifeDeathWeapon, IOnHitEffectProvider
    {
        ...
        public DaoEffectTags[] OnHitEffects => new[] { DaoEffectTags.DoT, DaoEffectTags.Heal };
        ...
        public override void SetDefaults()
        {
            ...
            Item.crit = 4;
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<LifeDeathBaseProj>();
            Item.shootSpeed = 10f;
        }
    }
}
