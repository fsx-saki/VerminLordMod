...
namespace VerminLordMod.Content.Items.Weapons.Zero
{
    ...
    /// 体现气道"真气化刃"的核心特点
    /// </summary>
    public class QiBaseGu : QiWeapon, IOnHitEffectProvider
    {
        ...
        public DaoEffectTags[] OnHitEffects => new[] { DaoEffectTags.QiRestore };
        ...
        public override void SetDefaults()
        {
            ...
            Item.crit = 4;
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<QiBaseProj>();
            Item.shootSpeed = 12f;
        }
    }
}
