...
namespace VerminLordMod.Content.Items.Weapons.Zero
{
    ...
    /// 体现力道"力破千钧"的核心特点
    /// </summary>
    public class PowerBaseGu : PowerWeapon, IOnHitEffectProvider
    {
        ...
        public DaoEffectTags[] OnHitEffects => new[] { DaoEffectTags.Push };
        ...
        public override void SetDefaults()
        {
            ...
            Item.crit = 4;
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<PowerBaseProj>();
            Item.shootSpeed = 10f;
        }
    }
}
