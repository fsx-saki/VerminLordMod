...
namespace VerminLordMod.Content.Items.Weapons.Zero
{
    /// <summary>
    /// 虚道基础蛊 — 虚空蛊
    /// 发射一枚虚道能量弹，命中后附加牵引、减速效果
    /// 体现虚道"虚空吞噬"的核心特点
    /// </summary>
    public class VoidBaseGu : VoidWeapon, IOnHitEffectProvider
    {
        ...
        public DaoEffectTags[] OnHitEffects => new[] { DaoEffectTags.Pull, DaoEffectTags.Slow };
        ...
        public override void SetDefaults()
        {
            ...
            Item.crit = 4;
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<VoidBaseProj>();
            Item.shootSpeed = 10f;
        }
    }
}
