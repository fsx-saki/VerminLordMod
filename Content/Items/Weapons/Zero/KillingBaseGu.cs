...
namespace VerminLordMod.Content.Items.Weapons.Zero
{
    ...
    /// 体现杀道"杀机毕露"的核心特点
    /// </summary>
    public class KillingBaseGu : KillingWeapon, IOnHitEffectProvider
    {
        ...
        public DaoEffectTags[] OnHitEffects => new[] { DaoEffectTags.StrongDoT };
        ...
        public override void SetDefaults()
        {
            ...
            Item.crit = 4;
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<KillingBaseProj>();
            Item.shootSpeed = 14f;
        }
    }
}
