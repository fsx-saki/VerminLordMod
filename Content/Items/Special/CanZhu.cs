...
{
    [ImplStatus(ImplStatus.Implemented, "六转火道仙蛊-追命火", "六转", "火")]
    public class CanZhu : FireWeapon, IOnHitEffectProvider
    {
        protected override int _guLevel => 6;
        protected override int qiCost => 70;
        ...
        public override void SetDefaults()
        {
            ...
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<CanZhuProj>();
            Item.shootSpeed = 8f;
            Item.noMelee = true;
