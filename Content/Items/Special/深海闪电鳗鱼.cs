...
{
    [ImplStatus(ImplStatus.Implemented, "三转雷道攻击蛊", "三转", "雷")]
    public class 深海闪电鳗鱼 : LightningWeapon, IOnHitEffectProvider
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.scale = 1f;
            Item.shoot = ModContent.ProjectileType<ShenHaiManYuProj>();
            Item.shootSpeed = 8f;
            Item.noMelee = true;
