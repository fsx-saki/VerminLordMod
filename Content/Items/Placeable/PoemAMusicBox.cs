...
{
	public class PoemAMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/Poem1"), ModContent.ItemType<PoemAMusicBox>(), ModContent.TileType<PoemAMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<PoemAMusicBoxTile>(), 0);
