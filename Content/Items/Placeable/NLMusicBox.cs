...
{
	public class NLMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/NianLun"), ModContent.ItemType<NLMusicBox>(), ModContent.TileType<NLMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<NLMusicBoxTile>(), 0);
