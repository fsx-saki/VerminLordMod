...
namespace VerminLordMod.Content.Items.Placeable.Walls
{
    ...
    public class QingMaoStoneWallItem : ModItem
    {
        public override void SetDefaults()
        {
            Item.width = 12; Item.height = 12; Item.maxStack = 999;
            ...
            Item.useAnimation = 15; Item.useTime = 7;
            Item.useStyle = ItemUseStyleID.Swing; Item.consumable = true;
            Item.createWall = ModContent.WallType<Content.Walls.QingMaoStoneWall>();
        }
    }

    public class BoneBanbooWallItem : ModItem
    {
        public override void SetDefaults()
        {
            Item.width = 12; Item.height = 12; Item.maxStack = 999;
            ...
            Item.useAnimation = 15; Item.useTime = 7;
            Item.useStyle = ItemUseStyleID.Swing; Item.consumable = true;
            Item.createWall = ModContent.WallType<Content.Walls.BoneBanbooWall>();
        }
    }
}
