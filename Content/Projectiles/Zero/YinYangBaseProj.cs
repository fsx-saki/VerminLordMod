    ...
    public class YinYangBaseProj : BaseBullet
    {
        ...
        protected override void RegisterBehaviors()
        {
            ...
            Behaviors.Add(new YinYangTrailBehavior
            {
                ...
                MaxRipples = 5,
                RippleLife = 42,
                RippleStartSize = 0.3f,
                RippleEndSize = 1.7f,
                RippleSpawnChance = 0.022f,
                RippleRotSpeed = 0.04f,
                RippleDriftSpeed = 0.08f,
                RippleColor = new Color(160, 150, 220, 150),

                MaxSparks = 25,
                SparkLife = 22,
                SparkSize = 0.25f,
                SparkSpawnChance = 0.22f,
                SparkDriftSpeed = 0.35f,
                SparkYinColor = new Color(80, 70, 140, 200),
                SparkYangColor = new Color(220, 215, 255, 200),
