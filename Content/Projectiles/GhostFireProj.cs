...
namespace VerminLordMod.Content.Projectiles
{
	public class GhostFireProj : ModProjectile
	{
		...
		public override void SetDefaults() {
			...
			; // Benefits from melee bonuses. MeleeNoSpeed means the item will not scale with attack speed.
		...
		public override void PostAI() {
			Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.BlueFlare); // Makes the projectile emit dust.
