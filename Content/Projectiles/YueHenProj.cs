...
namespace VerminLordMod.Content.Projectiles
{
	...
	/// 月痕弹 — 月痕蛊，蓝焰月刃，附月噬效果。
	/// </summary>
	public class YueHenProj : BaseBullet
	{
		protected override void RegisterBehaviors()
		{
			Behaviors.Add(new AimBehavior(speed: 0f)
			{
				...
				EnableLight = true, LightColor = new Vector3(0.6f, 0.6f, 0.9f)
			});
			...
			{
				GlowColor = new Color(160, 180, 255),
			...
			Behaviors.Add(new DustOnHitBehavior
			{
				...
				SpeedMin = 1f, SpeedMax = 3f, ScaleMin = 0.8f, ScaleMax = 1.5f, Color = Color.Lavender
			});
		}
		...
		protected override void OnSpawned(IEntitySource source)
		{
			...
			if (tb != null)
			{
				...
				tb.TrailManager.NewTrail(tex,
					color: new Color(160, 180, 255, 200),
					maxPositions: 16, widthScale: 1.2f, lengthScale: 1.6f, alpha: 0.7f, recordInterval: 2);
			}
		}

		protected override void OnKilled(int timeLeft)
		{
			MoonBurstHelper.SpawnSmallBurst(Projectile.Center, new Color(160, 180, 255));
		}
