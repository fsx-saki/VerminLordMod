...
{
	public class YueXXProj : BaseBullet
	{
		protected override void RegisterBehaviors()
		{
			Behaviors.Add(new AimBehavior(speed: 0f)
			{
				...
				EnableLight = true, LightColor = new Vector3(0.6f, 0.7f, 0.9f)
			});

			Behaviors.Add(new TrailBehavior { AutoDraw = true, SuppressDefaultDraw = false });
			Behaviors.Add(new GlowDrawBehavior
			{
				GlowColor = new Color(150, 180, 220),
		...
		protected override void OnSpawned(IEntitySource source)
		{
			...
			if (tb != null)
			{
				...
				tb.TrailManager.NewTrail(tex,
					color: new Color(150, 180, 220, 200),
		...
		{
			MoonBurstHelper.SpawnSmallBurst(Projectile.Center, new Color(150, 180, 220));
		}
