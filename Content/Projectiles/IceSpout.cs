...
namespace VerminLordMod.Content.Projectiles
{
	class IceSpout : ModProjectile
	{
		public override void SetDefaults() {
			...
			Projectile.extraUpdates = 3; // 弹幕每帧的额外更新次数，默认0，这个之后细讲
									 // 以及写一些关于无敌帧的设定
		}
		...
		public override void AI() {
			...
			var targetVel = Vector2.Normalize(Main.LocalPlayer.Center + new Vector2(random.Next(80, 160), random.Next(50, 75)) - Projectile.Center) * 10f ;
			// 加权平均 1份目标速度和10份当前速度
