...
namespace VerminLordMod.Content.Projectiles
{
	public class YanTongHoldout : ModProjectile
	{
		...
		public const float MaxCharge = 15f;
		...
		private void FireBeams() {
			...
			for (int b = 0; b < NumBeams; ++b) {
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, beamVelocity, ModContent.ProjectileType<YanTongBeam>(), damage, knockback, Projectile.owner, b, uuid);
			}
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Color drawColor = YanTongGu.OverrideColor;
