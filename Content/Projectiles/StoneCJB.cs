...
namespace VerminLordMod.Content.Projectiles
{
	class StoneCJB:ModProjectile
	{
		...
		public override void SetDefaults() {
			...
			tex = ModContent.Request<Texture2D>("VerminLordMod/Content/Projectiles/StoneCJB").Value;
		}
		...
		public override void OnSpawn(IEntitySource source) {
			...
			trailManager.AddGhostTrail(trailTex,
				...
				maxPositions: 16,
				widthScale: 0.4f,
				lengthScale: 0.4f,  // 原版 StoneCJB 使用 0.4f,0.4f
				alpha: 0.8f,
				recordInterval: 2);
		}
