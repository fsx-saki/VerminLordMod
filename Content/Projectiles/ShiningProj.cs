...
{
	class ShiningProj : ModProjectile
	{
		...
		public override void OnKill(int timeLeft) {
			Projectile projectile = Projectile.NewProjectileDirect(null, Projectile.position, Vector2.Zero, ModContent.ProjectileType<WhiteLightProj>(), 0, 0);
			//Main.NewText("succ");
		}
	}
}
