...
{
	public class BaoYueProjangWangGu : BaseBullet
	{
		protected override void RegisterBehaviors()
		{
			Behaviors.Add(new AimBehavior(speed: 0f)
			{
				...
				EnableLight = true, LightColor = new Vector3(0.8f, 0.7f, 1.0f)
			});

			Behaviors.Add(new TrailBehavior { AutoDraw = true, SuppressDefaultDraw = false });
			Behaviors.Add(new GlowDrawBehavior
			{
				GlowColor = new Color(200, 180, 255),
		...
		{
			MoonBurstHelper.SpawnSmallBurst(Projectile.Center, new Color(200, 180, 255));
		}
