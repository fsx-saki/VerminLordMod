...
namespace VerminLordMod.Content.Buffs.Combo.IceBladeStorm
{
	class IceBladeStorm2 : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			Dust dust = Dust.NewDustDirect(player.Center, player.width, player.height, DustID.Ice);
			dust.noGravity = true;
