...
namespace VerminLordMod.Content.Buffs.AddToSelf.Pobuff
{
	public class Starbuff : ModBuff
	{
		...
		public static Starbuff[] starbuffs = {
			ModContent.GetInstance<OneStarbuff>(),
			ModContent.GetInstance<TwoStarbuff>(),
			ModContent.GetInstance<ThreeStarbuff>(),
			ModContent.GetInstance<FourStarbuff>(),
			ModContent.GetInstance<FiveStarbuff>(),
		};
