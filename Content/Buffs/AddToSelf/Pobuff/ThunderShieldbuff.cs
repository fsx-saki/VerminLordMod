...
{
	class ThunderShieldbuff : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if(Randommer.Roll(5)){
				for (int i = 0; i < 36; i++) {
					float r2 = i * MathHelper.Pi / 18f;
					Vector2 diffVel = r2.ToRotationVector2() * 25;
					Dust dust = Dust.NewDustDirect(player.Center + diffVel, 1, 1, DustID.WitherLightning);
					dust.velocity *= 0.2f;
					dust.noGravity = true;
				}
			}
