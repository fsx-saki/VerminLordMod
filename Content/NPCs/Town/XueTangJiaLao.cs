...
{
    [AutoloadHead]
    public class XueTangJiaLao : GuYueNPCBase
    {
        ...
        public override string HeadTexture => "VerminLordMod/Content/NPCs/Town/XueTangJiaLao_Head";
        ...
        {
            var b = new DialogueTreeBuilder("XueTangJiaLao", "greeting");
