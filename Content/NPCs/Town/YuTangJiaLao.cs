...
namespace VerminLordMod.Content.NPCs.Town
{
	...
	class YuTangJiaLao : ModNPC
	{
		...
		public override void SetStaticDefaults() {
			...
			.SetBiomeAffection<SnowBiome>(AffectionLevel.Hate) // Example Person prefers the forest.
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) {
			...
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("古月家族御堂家老"),

				// You can add multiple elements if you really wanted to
				// You can also use localization keys (see Localization/en-US.lang)
				new FlavorTextBestiaryInfoElement("Mods.VerminLordMod.Bestiary.YuTangJiaLao")
			});
		}
		...
		public override string GetChat() {
			...
			chat.Add(Language.GetTextValue("战斗中受伤可以避免。"));
			chat.Add(Language.GetTextValue("每转蛊师能从饰品蛊中获取的防御属性有限。"));
			chat.Add(Language.GetTextValue("当你装备不上蛊虫时，请尝试脱下所有饰品，优先装备蛊虫。"));
