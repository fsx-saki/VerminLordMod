...
{
	public class QingMaoStoneDoorOpen : ModTile
	{
		public override void SetStaticDefaults() {
			...
			TileID.Sets.CloseDoorID[Type] = ModContent.TileType<QingMaoStoneDoorClosed>();
			...
			RegisterItemDrop(ModContent.ItemType<QingMaoStoneDoor>(), 0);
			TileID.Sets.CloseDoorID[Type] = ModContent.TileType<QingMaoStoneDoorClosed>();
		...
		public override void MouseOver(int i, int j) {
			...
			player.cursorItemIconID = ModContent.ItemType<QingMaoStoneDoor>();
		}
	}
}