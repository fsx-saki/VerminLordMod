...
{        /// <summary>
        ...
        public class SpiritHerbPlot : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(80, 200, 120), CreateMapEntryName());
        ...
        public class GuBreedingVat : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(100, 60, 40), CreateMapEntryName());
        ...
        public class MeditationCushion : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(180, 50, 50), CreateMapEntryName());
        ...
        {
            Main.NewText("盘膝而坐，灵气缓缓流入体内……", Color.Cyan);
            return true;
        }
        ...
        public class GuCauldron : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(80, 80, 90), CreateMapEntryName());
        ...
        public override bool RightClick(int i, int j)
        {
            Main.NewText("炼蛊鼎中散发着奇异的气味……", Color.Orange);
            return true;
        }
        ...
        public class YuanStoneCluster : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(100, 180, 255), CreateMapEntryName());
        ...
        public class AncientTreeMoss : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileObjectData.newTile.CoordinateHeights = new[] { 18 };
            TileObjectData.newTile.CoordinatePaddingFix = new Point16(0, 2);
            TileObjectData.newTile.AnchorValidTiles = new int[] { TileID.WoodBlock, TileID.LivingWood, TileID.Dirt, TileID.Stone };
            TileObjectData.newTile.AnchorBottom = new AnchorData(AnchorType.SolidTile, 1, 0);
            TileObjectData.addTile(Type);

            AddMapEntry(new Color(50, 120, 50), CreateMapEntryName());
        ...
        public class GuWormHole : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(60, 40, 30), CreateMapEntryName());
        ...
        public class MoonlitPond : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(80, 120, 200), CreateMapEntryName());
        ...
        public class WitheredTree : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(100, 80, 60), CreateMapEntryName());
        ...
        public class SpiritBeastDen : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(70, 50, 40), CreateMapEntryName());
        ...
        public class HerbDryingRack : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(160, 140, 80), CreateMapEntryName());
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48,
                ModContent.ItemType<Items.Placeable.Environment.HerbDryingRack>());
        }
    }
}
