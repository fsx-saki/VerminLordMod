...
namespace VerminLordMod.Content.Biomes
{
	...
	public class QingMaoSurfaceBiome : ModBiome
	{
		// Select all the scenery
		public override ModWaterStyle WaterStyle => ModContent.GetInstance<QingMaoWaterStyle>(); // Sets a water style for when inside this biome
		...
		public override bool IsBiomeActive(Player player) {
			...
			bool b1 = ModContent.GetInstance<QingMaoBiomeTileCount>().exampleBlockCount >= 40;
