...
{
	public class QingmaoUndergroundBiome : ModBiome
	{
		// Select all the scenery
		public override ModUndergroundBackgroundStyle UndergroundBackgroundStyle => ModContent.GetInstance<QingMaoUndergroundBackgroundStyle>();
		...
		public override bool IsBiomeActive(Player player) {
			...
			return (player.ZoneRockLayerHeight || player.ZoneDirtLayerHeight) &&
				...
				ModContent.GetInstance<QingMaoBiomeTileCount>().exampleBlockCount >= 40 &&
